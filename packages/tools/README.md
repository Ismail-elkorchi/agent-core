...
`defineTool` is typed construction. `ToolRegistry` registration is the single checked adoption point that snapshots schemas, effect envelopes, requirements, and callbacks before runtime use.
