...
The package also defines the pure one-shot ticket and exact-settlement state machine consumed by the durable runtime. It does not execute effects, store run state, or provide a general transaction or compensation framework.
